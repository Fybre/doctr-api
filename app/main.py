...
from app.routes import detection, kie, ocr, recognition, ocrtext, ocrjson
...
app.include_router(ocrtext.router, prefix="/ocrtext", tags=["ocrtext"])
app.include_router(ocrjson.router, prefix="/ocrjson", tags=["ocrjson"])
